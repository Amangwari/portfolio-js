  ...
  "56d7": function (t, e, a) {
    ...
    var n = a("2b0e"),
      ...
      d = {
        ...
        links: {
          ...
          instagram: "https://www.instagram.com/aman.gwari/",
        },
        Education: [
          {
        ...
        Experience: [
          {
            ...
            description: [
              "Developed the B2B service company website from scratch using JavaScript, ES6, React and Redux Understanding the requirements of the company. Building the Front-End user responsive interfaces and user experiences using ReactJs, CSS, and external UI libraries like Bootstrap, MUI and Chakra UI. Created reusable react components and managed application state using React-Redux. Maintaining and modifying clients website as per requirements. ",
            ],
            skills: [
              "HTML5",
              "CSS3",
          ...
          {
            name: "IT4T Solutions-Travel Technology Company",
            date: "April 2023 - Present",
            position: "Frontend Developer",
            location: "Noida, Uttar Pradesh",
            description: [
              "As an individual working as a frontend developer for a travel technology software company, my primary responsibility is to create visually appealing website designs and enhance the user experience of the software. My role is to ensure that users have a seamless experience when using the platform, making it easy for them to navigate and complete tasks.",
            ],
            skills: [
              "HTML5",
              "CSS3",
    ...
    var X = {
      ...
      nt = {
        name: "Footer",
        data: function () {
          return { linkedin: u.links.linkedin, github: u.links.github, instagram: u.links.instagram};
        },
        methods: {
          open: function (t) {
            switch (t) {
